/* ============================================================
   HIDE & HONEY — interactions (mock storefront)
   ============================================================ */
(function () {
  'use strict';
  ...
  document.addEventListener('click', (e) => {
    ...
    if (a === 'checkout') { e.preventDefault(); alert('Demo storefront — checkout is mocked. In a live Shopify store this routes to secure checkout.'); }
  });
  ...
  $$('.pthumb').forEach(t => t.addEventListener('click', () => {
    ...
    if (main && img) main.innerHTML = `<img src="${img.src}" alt="">`;
  }));
